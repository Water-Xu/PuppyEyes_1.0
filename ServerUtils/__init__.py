...
if __name__ == '__main__':
    ...
    dirpath = r'/Users/water_xu/Desktop/train2'  # 原来存放xml文件的目录
    newdir = r'/Users/water_xu/Desktop/train2txt'  # 修改label后形成的txt目录

    if not os.path.exists(newdir):
        os.makedirs(newdir)

    dict_info = {'stop': 0, 'continue': 1}  # 有几个 类别 填写几个label names
